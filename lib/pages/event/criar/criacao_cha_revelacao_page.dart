...
class CriarChaRevelacaoPage extends StatefulWidget {
  const CriarChaRevelacaoPage({super.key});
  static const String routeName = '/criar-cha-revelacao';

  @override
  State<CriarChaRevelacaoPage> createState() => _CriarChaRevelacaoPageState();
}

class _CriarChaRevelacaoPageState extends State<CriarChaRevelacaoPage> {
  final _formKey = GlobalKey<FormState>();

  final TextEditingController tituloController = TextEditingController();
  final TextEditingController descricaoController = TextEditingController();
  final TextEditingController tipoController = TextEditingController(text: 'Chá Revelação');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Criar Chá Revelação"),
      ),
      body: Padding(
